...
#pragma region
	...
	*/
	...
	finalShit[0] = { -0.5f,  0.5f, 0.0f, 0.0f,0.0f };
	finalShit[1] = {  0.5f, -0.5f, 0.0f, 1.0f,1.0f };
	finalShit[2] = { -0.5f, -0.5f, 0.0f, 0.0f,1.0f };
							
	finalShit[3] = { -0.5f,  0.5f, 0.0f, 0.0f,0.0f };
	finalShit[4] = {  0.5f,  0.5f, 0.0f, 1.0f,0.0f };
	finalShit[5] = {  0.5f, -0.5f, 0.0f, 1.0f,1.0f };
...
HRESULT CreateDirect3DContext(HWND wndHandle)
{
	...
	if (SUCCEEDED(hr))
	{
		...
		PositionStencil->Release();
		NormalStencil->Release();
		ColorStencil->Release();
